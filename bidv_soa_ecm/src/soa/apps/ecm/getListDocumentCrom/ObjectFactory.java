...
import soa.common.AdditionalInformationType;
import soa.common.ClientType;
import soa.common.CommonType;
import soa.common.HeaderType;
import soa.common.NameValuePairsType;
import soa.common.ResponseStatusErroInfoType;
import soa.common.ResponseStatusType;
import soa.common.TargetAppIDs;
import soa.common.UserDetail;

/**
 * This object contains factory methods for each 
 * Java content interface and Java element interface 
 * generated in the soa.ecm.getlistCrom package. 
...
public class ObjectFactory {
    ...
    private final static QName _BodyResGetListDocumentFromCROM_QNAME = new QName("http://www.bidv.com/global/vn/apps/ecm/getlistdocumentfromcrom/1.0", "BodyResGetListDocumentFromCROM");
    private final static QName _BodyReqGetListDocumentFromCROM_QNAME = new QName("http://www.bidv.com/global/vn/apps/ecm/getlistdocumentfromcrom/1.0", "BodyReqGetListDocumentFromCROM");
    ...
    private final static QName _GetListDocumentFromCROMReq_QNAME = new QName("http://www.bidv.com/global/vn/apps/ecm/getlistdocumentfromcrom/1.0", "GetListDocumentFromCROMReq");
    private final static QName _GetListDocumentFromCROMRes_QNAME = new QName("http://www.bidv.com/global/vn/apps/ecm/getlistdocumentfromcrom/1.0", "GetListDocumentFromCROMRes");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: soa.ecm.getlistCrom
     * 
     */
    ...
    /**
     * Create an instance of {@link BodyResGetListDocumentFromCROMType }
     * 
     */
    public BodyResGetListDocumentFromCROMType createBodyResGetListDocumentFromCROMType() {
        return new BodyResGetListDocumentFromCROMType();
    }

    /**
     * Create an instance of {@link GetListDocumentFromCROMReqType }
     * 
     */
    public GetListDocumentFromCROMReqType createGetListDocumentFromCROMReqType() {
        return new GetListDocumentFromCROMReqType();
    }

    /**
     * Create an instance of {@link BodyReqGetListDocumentFromCROMType }
     * 
     */
    public BodyReqGetListDocumentFromCROMType createBodyReqGetListDocumentFromCROMType() {
        return new BodyReqGetListDocumentFromCROMType();
    }

    /**
     * Create an instance of {@link GetListDocumentFromCROMResType }
     * 
     */
    public GetListDocumentFromCROMResType createGetListDocumentFromCROMResType() {
        return new GetListDocumentFromCROMResType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link BodyResGetListDocumentFromCROMType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/global/vn/apps/ecm/getlistdocumentfromcrom/1.0", name = "BodyResGetListDocumentFromCROM")
    public JAXBElement<BodyResGetListDocumentFromCROMType> createBodyResGetListDocumentFromCROM(BodyResGetListDocumentFromCROMType value) {
        return new JAXBElement<BodyResGetListDocumentFromCROMType>(_BodyResGetListDocumentFromCROM_QNAME, BodyResGetListDocumentFromCROMType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link BodyReqGetListDocumentFromCROMType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/global/vn/apps/ecm/getlistdocumentfromcrom/1.0", name = "BodyReqGetListDocumentFromCROM")
    public JAXBElement<BodyReqGetListDocumentFromCROMType> createBodyReqGetListDocumentFromCROM(BodyReqGetListDocumentFromCROMType value) {
        return new JAXBElement<BodyReqGetListDocumentFromCROMType>(_BodyReqGetListDocumentFromCROM_QNAME, BodyReqGetListDocumentFromCROMType.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetListDocumentFromCROMReqType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/global/vn/apps/ecm/getlistdocumentfromcrom/1.0", name = "GetListDocumentFromCROMReq")
    public JAXBElement<GetListDocumentFromCROMReqType> createGetListDocumentFromCROMReq(GetListDocumentFromCROMReqType value) {
        return new JAXBElement<GetListDocumentFromCROMReqType>(_GetListDocumentFromCROMReq_QNAME, GetListDocumentFromCROMReqType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetListDocumentFromCROMResType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/global/vn/apps/ecm/getlistdocumentfromcrom/1.0", name = "GetListDocumentFromCROMRes")
    public JAXBElement<GetListDocumentFromCROMResType> createGetListDocumentFromCROMRes(GetListDocumentFromCROMResType value) {
        return new JAXBElement<GetListDocumentFromCROMResType>(_GetListDocumentFromCROMRes_QNAME, GetListDocumentFromCROMResType.class, null, value);
    }
