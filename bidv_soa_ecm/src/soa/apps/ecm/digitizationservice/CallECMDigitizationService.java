...
public class CallECMDigitizationService {
	...
	public static void main(String[] args) {
		...
		body.setAccessToken("BIDVECM");
		body.setAppCode("BIDVECM");
		body.setChecksum("dBu9E+IGoVuAD6kJN02ZFUx56HaFG3aDFtBrygV8FRHEsfMnyplVNYG2fZtYMjVU+9A+XsY3sc00BOK8q/h9uQ==");
		body.setRequestID("2232334");
