...
public class GetListAcctByCif {
	public static void main(String[] args) {
		...
		infoConfig.setQueueName("vn.acctlist.1.0");// trong file wsdl
		infoConfig.setSoapActionInWSDL("global/vn/account/acctlist/1.0/ListAcc");// trong
																												// file
																												// wsdl
		BodyReqInquiryType body = new BodyReqInquiryType();
		
		body.setCustomerNo("13982132");
		
		AcctInfoType accouInfoType = new AcctInfoType();
		accouInfoType.setAcctNo("");
		...
		GetListAcctByCif cus = new GetListAcctByCif();
		try {
	...
	public String get(String messID, String soaappcode, String domain, String version, BodyReqInquiryType body,
		...
		String response = "";
		ListAccReqType obj = new ListAccReqType();
		...
		SOARequestObject genSOAMsgObj = soaReqestReply.GenerateSOAMessage(ListAccReqType.class, obj);
	...
	private String printXml(String str) {
		try {
			...
			//str = str.replace("xmlns:ns3=\"http://www.bidv.com/global/common/account/1.0\"", "");
