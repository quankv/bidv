...
public class DetailEntryHold {
	public static void main(String[] args) {
		...
		infoConfig.setQueueName("vn.acchold.1.0");// trong file wsdl
		infoConfig.setSoapActionInWSDL("/Services/Global/Vn/Account/AccHold/OperationImpl/AccHold.serviceagent//DetailEntryHold");// trong
																												// file
																												// wsdl
		BodyReqDetailEntryHoldType body = new BodyReqDetailEntryHoldType();
		...
		DetailEntryHold cus = new DetailEntryHold();
		try {
	...
	public static String transfer(String jsonConfig, String jsonBody) throws Exception{
		...
		if (jsonConfig != null && !"".equals(jsonConfig) && jsonBody != null && !"".equals(jsonBody)) {
			...
			String requestId = genReqId(appCode, deviceId);
			BodyReqDetailEntryHoldType body = new BodyReqDetailEntryHoldType();
			body = g.fromJson(jsonBody, BodyReqDetailEntryHoldType.class);
	...
	public String get(String messID, String soaappcode, String domain, String version, BodyReqDetailEntryHoldType body,
			String queueName, String soapActionInWSDL) {
		String response = "";
		AccDetailEntryHoldReqType obj = new AccDetailEntryHoldReqType();
		...
		obj.setBodyReqDetailEntryHold(body);

		SOARequestObject genSOAMsgObj = soaReqestReply.GenerateSOAMessage(AccDetailEntryHoldReqType.class, obj);
	...
	private String printXml(String str) {
		try {
			...
			str = str.replace("xmlns:ns0=\"http://www.bidv.com/global/vn/account/accthold/unhold/1.0\"", "");
