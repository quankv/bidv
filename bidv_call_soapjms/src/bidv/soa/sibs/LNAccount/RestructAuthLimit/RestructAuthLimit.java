...
public class RestructAuthLimit {
	public static void main(String[] args) {
		...
		infoConfig.setSoapActionInWSDL("/Services/Global/Vn/Loan/LNAccount/OperationImpl/LNAccount.serviceagent//RestructAuthLimit");//trong file wsdl
		BodyReqType body = new BodyReqType();
		BaseXferType baseXfer = new BaseXferType();
		baseXfer.setTellerId("990BPM");
		baseXfer.setSvrBranch("120");
		body.setBaseXfer(baseXfer);
		
		body.setAcctNo("12082000737134");
		body.setAcctType("L");
		body.setActionCode("IC");
		body.setOrgAmt("150000000");
		body.setAvailLimit("150000000");
		...
		RestructAuthLimit cus = new RestructAuthLimit();
		try {
	...
	public static String callRestructAuthLimit(String jsonConfig, String jsonBody) {
		String response = "";
		if(jsonConfig != null && !"".equals(jsonConfig) && jsonBody != null && !"".equals(jsonBody) ) {
			...
			try {
				...
				String requestId = genReqId(appCode, deviceId);
				BodyReqType body = new BodyReqType();
				body = g.fromJson(jsonBody, BodyReqType.class);
	...
	public String get(String messID, String soaappcode, String domain, String version, BodyReqType body, String queueName, String soapActionInWSDL) {
		String response = "";
		RestructLimitReqType obj = new RestructLimitReqType();
		...
		SOARequestObject genSOAMsgObj = soaReqestReply.GenerateSOAMessage(RestructLimitReqType.class,
				obj);
