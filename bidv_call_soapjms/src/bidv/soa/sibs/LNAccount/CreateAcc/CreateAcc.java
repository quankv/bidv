...
public class CreateAcc {
	...
	public static String callCreateAcc(String jsonConfig, String jsonBody) {
		String response = "";
	...
	public String get(String messID, String soaappcode, String domain, String version, BodyReqCreateType body, String queueName, String soapActionInWSDL) {
		String response = "";
