...
public class DisbValue {
	public static void main(String[] args) {
		...
		infoConfig.setSoapActionInWSDL("/Services/Global/Vn/Loan/LNAccount/OperationImpl/LNAccount.serviceagent//DisbValueDateFile");//trong file wsdl
	...
	public static String callDisbValue(String jsonConfig, String jsonBody) {
		String response = "";
	...
	public String get(String messID, String soaappcode, String domain, String version, BodyReqType body, String queueName, String soapActionInWSDL) {
		String response = "";
		DisbValueReqType obj = new DisbValueReqType();
		...
		SOARequestObject genSOAMsgObj = soaReqestReply.GenerateSOAMessage(DisbValueReqType.class,
				obj);
