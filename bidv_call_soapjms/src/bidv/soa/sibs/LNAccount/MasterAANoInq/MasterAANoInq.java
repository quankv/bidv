...
public class MasterAANoInq {
	public static void main(String[] args) {
		...
		infoConfig.setSoapActionInWSDL("/Services/Global/Vn/Loan/LNAccount/OperationImpl/LNAccount.serviceagent//MasterAANoInq");//trong file wsdl
		...
		MasterAANoInq cus = new MasterAANoInq();
		try {
	...
	public static String inquiryMasterAANo(String jsonConfig, String jsonBody) {
		String response = "";
	...
	public String get(String messID, String soaappcode, String domain, String version, BodyReqType body, String queueName, String soapActionInWSDL) {
		String response = "";
		MasterAANoInqReqType obj = new MasterAANoInqReqType();
		...
		SOARequestObject genSOAMsgObj = soaReqestReply.GenerateSOAMessage(MasterAANoInqReqType.class,
				obj);
