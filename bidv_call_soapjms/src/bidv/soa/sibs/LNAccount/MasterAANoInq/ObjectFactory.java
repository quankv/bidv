 ...
 * generated in the soa.sibs.LNAccount.MasterAANoInq package. 
...
public class ObjectFactory {
    ...
    private final static QName _MasterAANoInqRes_QNAME = new QName("http://www.bidv.com/entity/vn/loan/lnaccount/masteraanoinq/1.0", "MasterAANoInqRes");
    private final static QName _MasterAANoInqReq_QNAME = new QName("http://www.bidv.com/entity/vn/loan/lnaccount/masteraanoinq/1.0", "MasterAANoInqReq");
    ...
    private final static QName _BodyRes_QNAME = new QName("http://www.bidv.com/entity/vn/loan/lnaccount/masteraanoinq/1.0", "BodyRes");
    private final static QName _MessageType_QNAME = new QName("http://www.bidv.com/common/envelope/commonheader/1.0", "MessageType");
    private final static QName _BodyReq_QNAME = new QName("http://www.bidv.com/entity/vn/loan/lnaccount/masteraanoinq/1.0", "BodyReq");
    private final static QName _Client_QNAME = new QName("http://www.bidv.com/common/envelope/commonheader/1.0", "Client");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: soa.sibs.LNAccount.MasterAANoInq
     * 
     */
    ...
    /**
     * Create an instance of {@link MasterAANoInqResType }
     * 
     */
    public MasterAANoInqResType createMasterAANoInqResType() {
        return new MasterAANoInqResType();
    }

    /**
     * Create an instance of {@link MasterAANoInqReqType }
     * 
     */
    public MasterAANoInqReqType createMasterAANoInqReqType() {
        return new MasterAANoInqReqType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link MasterAANoInqResType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/loan/lnaccount/masteraanoinq/1.0", name = "MasterAANoInqRes")
    public JAXBElement<MasterAANoInqResType> createMasterAANoInqRes(MasterAANoInqResType value) {
        return new JAXBElement<MasterAANoInqResType>(_MasterAANoInqRes_QNAME, MasterAANoInqResType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link MasterAANoInqReqType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/loan/lnaccount/masteraanoinq/1.0", name = "MasterAANoInqReq")
    public JAXBElement<MasterAANoInqReqType> createMasterAANoInqReq(MasterAANoInqReqType value) {
        return new JAXBElement<MasterAANoInqReqType>(_MasterAANoInqReq_QNAME, MasterAANoInqReqType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/loan/lnaccount/masteraanoinq/1.0", name = "BodyRes")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/loan/lnaccount/masteraanoinq/1.0", name = "BodyReq")
