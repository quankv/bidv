...
public class ACFDetail {
	...
	public static String acfDetail(String jsonConfig, String jsonBody) {
		String response = "";
	...
	public String get(String messID, String soaappcode, String domain, String version, BodyReqType body, String queueName, String soapActionInWSDL) {
		String response = "";
		ACFDetailReqType obj = new ACFDetailReqType();
		...
		SOARequestObject genSOAMsgObj = soaReqestReply.GenerateSOAMessage(ACFDetailReqType.class,
				obj);
