...
public class MasterInqInfoAccount {
	public static void main(String[] args) {
		...
		infoConfig.setQueueName("vn.acctdetail.1.0");// trong file wsdl
		infoConfig.setSoapActionInWSDL("global/vn/account/acctdetail/1.0/MasterInq");// trong
																												// file
																												// wsdl
		BodyReqMasterInquiryType body = new BodyReqMasterInquiryType();
		AcctInfoType accouInfoType = new AcctInfoType();
		accouInfoType.setAcctNo("12010000060868");
		accouInfoType.setAcctType("D");
		body.setAccInfoType(accouInfoType);
		body.setSearchMethod("");// phai set
		body.setMoreRecordIndicator("");// phai set
		body.setTransactionMode("");// phai set
		...
		MasterInqInfoAccount cus = new MasterInqInfoAccount();
		try {
	...
	public static String transfer(String jsonConfig, String jsonBody) throws Exception{
		...
		if (jsonConfig != null && !"".equals(jsonConfig) && jsonBody != null && !"".equals(jsonBody)) {
			...
			String requestId = genReqId(appCode, deviceId);
			BodyReqMasterInquiryType body = new BodyReqMasterInquiryType();
			body = g.fromJson(jsonBody, BodyReqMasterInquiryType.class);
	...
	public String get(String messID, String soaappcode, String domain, String version, BodyReqMasterInquiryType body,
			String queueName, String soapActionInWSDL) {
		String response = "";
		MasterInqReqType obj = new MasterInqReqType();
		...
		obj.setBodyReqMasterInquiry(body);

		SOARequestObject genSOAMsgObj = soaReqestReply.GenerateSOAMessage(MasterInqReqType.class, obj);
