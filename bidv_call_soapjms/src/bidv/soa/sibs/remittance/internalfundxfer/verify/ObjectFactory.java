 ...
 * generated in the soa.sibs.Remittance.Internal.verify package. 
...
public class ObjectFactory {
    ...
    private final static QName _InternalFundXferReq_QNAME = new QName("http://www.bidv.com/entity/vn/remittance/internalfundxfer/verify/1.0", "InternalFundXferReq");
    private final static QName _InternalFundXferRes_QNAME = new QName("http://www.bidv.com/entity/vn/remittance/internalfundxfer/verify/1.0", "InternalFundXferRes");
    ...
    private final static QName _BodyResVerify_QNAME = new QName("http://www.bidv.com/entity/vn/remittance/internalfundxfer/verify/1.0", "BodyResVerify");
    private final static QName _TargetAppID_QNAME = new QName("http://www.bidv.com/common/envelope/commonheader/1.0", "TargetAppID");
    private final static QName _BodyReqVerify_QNAME = new QName("http://www.bidv.com/entity/vn/remittance/internalfundxfer/verify/1.0", "BodyReqVerify");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: soa.sibs.Remittance.Internal.verify
     * 
     */
    ...
    /**
     * Create an instance of {@link BodyReqVerifyType }
     * 
     */
    public BodyReqVerifyType createBodyReqVerifyType() {
        return new BodyReqVerifyType();
    }

    /**
     * Create an instance of {@link BodyResVerifyType }
     * 
     */
    public BodyResVerifyType createBodyResVerifyType() {
        return new BodyResVerifyType();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/remittance/internalfundxfer/verify/1.0", name = "InternalFundXferReq")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/remittance/internalfundxfer/verify/1.0", name = "InternalFundXferRes")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link BodyResVerifyType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/remittance/internalfundxfer/verify/1.0", name = "BodyResVerify")
    public JAXBElement<BodyResVerifyType> createBodyResVerify(BodyResVerifyType value) {
        return new JAXBElement<BodyResVerifyType>(_BodyResVerify_QNAME, BodyResVerifyType.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link BodyReqVerifyType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/remittance/internalfundxfer/verify/1.0", name = "BodyReqVerify")
    public JAXBElement<BodyReqVerifyType> createBodyReqVerify(BodyReqVerifyType value) {
        return new JAXBElement<BodyReqVerifyType>(_BodyReqVerify_QNAME, BodyReqVerifyType.class, null, value);
    }
