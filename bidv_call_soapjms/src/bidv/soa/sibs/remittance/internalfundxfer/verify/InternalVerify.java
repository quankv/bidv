...
public class InternalVerify {
	public static void main(String[] args) {
		...
		infoConfig.setSoapActionInWSDL("/Services/Global/Vn/Remittance/InternalFundXfer/OperationImpl/InternalFundXfer-service2.serviceagent/PortTypeEndpoint2/Verify");// trong
																												// file
																												// wsdl
		...
		InternalVerify cus = new InternalVerify();
		try {
