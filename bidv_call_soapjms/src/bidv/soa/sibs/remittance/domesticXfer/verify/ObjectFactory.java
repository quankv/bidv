 ...
 * generated in the soa.sibs.Remittance.DomesticXfer.verify package. 
...
public class ObjectFactory {
    ...
    private final static QName _DomesticXferReq_QNAME = new QName("http://www.bidv.com/entity/vn/remittance/domesticxfer/verify/1.0", "DomesticXferReq");
    ...
    private final static QName _BodyReqVerify_QNAME = new QName("http://www.bidv.com/entity/vn/remittance/domesticxfer/verify/1.0", "BodyReqVerify");
    private final static QName _DomesticXferRes_QNAME = new QName("http://www.bidv.com/entity/vn/remittance/domesticxfer/verify/1.0", "DomesticXferRes");
    ...
    private final static QName _BodyResVerify_QNAME = new QName("http://www.bidv.com/entity/vn/remittance/domesticxfer/verify/1.0", "BodyResVerify");
    private final static QName _Client_QNAME = new QName("http://www.bidv.com/common/envelope/commonheader/1.0", "Client");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: soa.sibs.Remittance.DomesticXfer.verify
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/remittance/domesticxfer/verify/1.0", name = "DomesticXferReq")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/remittance/domesticxfer/verify/1.0", name = "BodyReqVerify")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/remittance/domesticxfer/verify/1.0", name = "DomesticXferRes")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/remittance/domesticxfer/verify/1.0", name = "BodyResVerify")
