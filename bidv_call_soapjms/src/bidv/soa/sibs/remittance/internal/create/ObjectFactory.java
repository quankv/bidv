 ...
 * generated in the soa.sibs.Remittance.Internal.Create package. 
...
public class ObjectFactory {
    ...
    private final static QName _InternalFundXferRes_QNAME = new QName("http://www.bidv.com/entity/vn/remittance/internalfundxfer/create/1.0", "InternalFundXferRes");
    ...
    private final static QName _InternalFundXferReq_QNAME = new QName("http://www.bidv.com/entity/vn/remittance/internalfundxfer/create/1.0", "InternalFundXferReq");
    ...
    private final static QName _BodyResCreate_QNAME = new QName("http://www.bidv.com/entity/vn/remittance/internalfundxfer/create/1.0", "BodyResCreate");
    ...
    private final static QName _BodyReqCreate_QNAME = new QName("http://www.bidv.com/entity/vn/remittance/internalfundxfer/create/1.0", "BodyReqCreate");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: soa.sibs.Remittance.Internal.Create
     * 
     */
    ...
    /**
     * Create an instance of {@link InternalFundXferReqType }
     * 
     */
    public InternalFundXferReqType createInternalFundXferReqType() {
        return new InternalFundXferReqType();
    }

    /**
     * Create an instance of {@link InternalFundXferResType }
     * 
     */
    public InternalFundXferResType createInternalFundXferResType() {
        return new InternalFundXferResType();
    }

    /**
     * Create an instance of {@link BodyResCreateType }
     * 
     */
    public BodyResCreateType createBodyResCreateType() {
        return new BodyResCreateType();
    }

    /**
     * Create an instance of {@link BodyReqCreateType }
     * 
     */
    public BodyReqCreateType createBodyReqCreateType() {
        return new BodyReqCreateType();
    }

    /**
     * Create an instance of {@link BriefPersonInfoType }
     * 
     */
    public BriefPersonInfoType createBriefPersonInfoType() {
        return new BriefPersonInfoType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link InternalFundXferResType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/remittance/internalfundxfer/create/1.0", name = "InternalFundXferRes")
    public JAXBElement<InternalFundXferResType> createInternalFundXferRes(InternalFundXferResType value) {
        return new JAXBElement<InternalFundXferResType>(_InternalFundXferRes_QNAME, InternalFundXferResType.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link InternalFundXferReqType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/remittance/internalfundxfer/create/1.0", name = "InternalFundXferReq")
    public JAXBElement<InternalFundXferReqType> createInternalFundXferReq(InternalFundXferReqType value) {
        return new JAXBElement<InternalFundXferReqType>(_InternalFundXferReq_QNAME, InternalFundXferReqType.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link BodyResCreateType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/remittance/internalfundxfer/create/1.0", name = "BodyResCreate")
    public JAXBElement<BodyResCreateType> createBodyResCreate(BodyResCreateType value) {
        return new JAXBElement<BodyResCreateType>(_BodyResCreate_QNAME, BodyResCreateType.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link BodyReqCreateType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/remittance/internalfundxfer/create/1.0", name = "BodyReqCreate")
    public JAXBElement<BodyReqCreateType> createBodyReqCreate(BodyReqCreateType value) {
        return new JAXBElement<BodyReqCreateType>(_BodyReqCreate_QNAME, BodyReqCreateType.class, null, value);
    }
