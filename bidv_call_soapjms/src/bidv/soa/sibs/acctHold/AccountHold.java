...
public class AccountHold {
	public static void main(String[] args) {
		...
		infoConfig.setSoapActionInWSDL("global/vn/account/accthold/1.0/hold");// trong
																												// file
																												// wsdl
		BodyReqAcctHoldType body = new BodyReqAcctHoldType();
		...
		AccountHold cus = new AccountHold();
		try {
	...
	public static String transfer(String jsonConfig, String jsonBody) throws Exception{
		...
		if (jsonConfig != null && !"".equals(jsonConfig) && jsonBody != null && !"".equals(jsonBody)) {
			...
			String requestId = genReqId(appCode, deviceId);
			BodyReqAcctHoldType body = new BodyReqAcctHoldType();
			body = g.fromJson(jsonBody, BodyReqAcctHoldType.class);
	...
	public String get(String messID, String soaappcode, String domain, String version, BodyReqAcctHoldType body,
			String queueName, String soapActionInWSDL) {
		String response = "";
		AcctHoldReqType obj = new AcctHoldReqType();
		...
		obj.setBodyReqAcctHold(body);

		SOARequestObject genSOAMsgObj = soaReqestReply.GenerateSOAMessage(AcctHoldReqType.class, obj);
