...
public class AccountUnHold {
	public static void main(String[] args) {
		...
		infoConfig.setSoapActionInWSDL("global/vn/account/accthold/1.0/unhold");// trong
																												// file
																												// wsdl
		BodyReqAcctUnholdType body = new BodyReqAcctUnholdType();
		...
		AccountUnHold cus = new AccountUnHold();
		try {
	...
	public static String transfer(String jsonConfig, String jsonBody) throws Exception{
		...
		if (jsonConfig != null && !"".equals(jsonConfig) && jsonBody != null && !"".equals(jsonBody)) {
			...
			String requestId = genReqId(appCode, deviceId);
			BodyReqAcctUnholdType body = new BodyReqAcctUnholdType();
			body = g.fromJson(jsonBody, BodyReqAcctUnholdType.class);
	...
	public String get(String messID, String soaappcode, String domain, String version, BodyReqAcctUnholdType body,
			String queueName, String soapActionInWSDL) {
		String response = "";
		AcctUnholdReqType obj = new AcctUnholdReqType();
		...
		obj.setBodyReqAcctUnhold(body);

		SOARequestObject genSOAMsgObj = soaReqestReply.GenerateSOAMessage(AcctUnholdReqType.class, obj);
