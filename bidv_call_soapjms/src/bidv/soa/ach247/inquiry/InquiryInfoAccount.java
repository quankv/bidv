...
public class InquiryInfoAccount {
	public static void main(String[] args) {
		...
		infoConfig.setQueueName("vn.apps.ach.1.0");//trong file wsdl
		...
		InquiryInfoAccount cus = new InquiryInfoAccount();
		try {
	...
	public static String inquiryAccount(String jsonConfig, String jsonBody) {
		...
		try {
			if(jsonConfig != null && !"".equals(jsonConfig) && jsonBody != null && !"".equals(jsonBody) ) {
				...
				try {
					...
					String requestId = genReqId(appCode, deviceId);
					BodyReqACHInquiryType body = new BodyReqACHInquiryType();
					body = g.fromJson(jsonBody, BodyReqACHInquiryType.class);
	...
	public String get(String messID, String soaappcode, String domain, String version, BodyReqACHInquiryType body, String queueName, String soapActionInWSDL) {
		String response = "";
		ACHInquiryReqType obj = new ACHInquiryReqType();
		...
		obj.setBodyReqACHInquiry(body);

		SOARequestObject genSOAMsgObj = soaReqestReply.GenerateSOAMessage(ACHInquiryReqType.class,
				obj);
