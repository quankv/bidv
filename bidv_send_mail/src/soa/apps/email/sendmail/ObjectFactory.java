 ...
 * generated in the soa.apps.email.sendmail package. 
...
public class ObjectFactory {
    ...
    private final static QName _BodyResSendEmail_QNAME = new QName("http://www.bidv.com/entity/vn/apps/email/sendemail/1.0", "BodyResSendEmail");
    ...
    private final static QName _EMAILSendEmailReq_QNAME = new QName("http://www.bidv.com/entity/vn/apps/email/sendemail/1.0", "EMAILSendEmailReq");
    private final static QName _EMAILSendEmailRes_QNAME = new QName("http://www.bidv.com/entity/vn/apps/email/sendemail/1.0", "EMAILSendEmailRes");
    ...
    private final static QName _BodyReqSendEmail_QNAME = new QName("http://www.bidv.com/entity/vn/apps/email/sendemail/1.0", "BodyReqSendEmail");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: soa.apps.email.sendmail
     * 
     */
    ...
    /**
     * Create an instance of {@link BodyReqSendEmailType }
     * 
     */
    public BodyReqSendEmailType createBodyReqSendEmailType() {
        return new BodyReqSendEmailType();
    }

    /**
     * Create an instance of {@link BodyResSendEmailType }
     * 
     */
    public BodyResSendEmailType createBodyResSendEmailType() {
        return new BodyResSendEmailType();
    }

    /**
     * Create an instance of {@link EMAILSendEmailResType }
     * 
     */
    public EMAILSendEmailResType createEMAILSendEmailResType() {
        return new EMAILSendEmailResType();
    }

    /**
     * Create an instance of {@link EMAILSendEmailReqType }
     * 
     */
    public EMAILSendEmailReqType createEMAILSendEmailReqType() {
        return new EMAILSendEmailReqType();
    }
    ...
    /**
     * Create an instance of {@link BodyReqSendEmailType.Attachments }
     * 
     */
    public BodyReqSendEmailType.Attachments createBodyReqSendEmailTypeAttachments() {
        return new BodyReqSendEmailType.Attachments();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link BodyResSendEmailType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/apps/email/sendemail/1.0", name = "BodyResSendEmail")
    public JAXBElement<BodyResSendEmailType> createBodyResSendEmail(BodyResSendEmailType value) {
        return new JAXBElement<BodyResSendEmailType>(_BodyResSendEmail_QNAME, BodyResSendEmailType.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link EMAILSendEmailReqType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/apps/email/sendemail/1.0", name = "EMAILSendEmailReq")
    public JAXBElement<EMAILSendEmailReqType> createEMAILSendEmailReq(EMAILSendEmailReqType value) {
        return new JAXBElement<EMAILSendEmailReqType>(_EMAILSendEmailReq_QNAME, EMAILSendEmailReqType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link EMAILSendEmailResType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/apps/email/sendemail/1.0", name = "EMAILSendEmailRes")
    public JAXBElement<EMAILSendEmailResType> createEMAILSendEmailRes(EMAILSendEmailResType value) {
        return new JAXBElement<EMAILSendEmailResType>(_EMAILSendEmailRes_QNAME, EMAILSendEmailResType.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link BodyReqSendEmailType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.bidv.com/entity/vn/apps/email/sendemail/1.0", name = "BodyReqSendEmail")
    public JAXBElement<BodyReqSendEmailType> createBodyReqSendEmail(BodyReqSendEmailType value) {
        return new JAXBElement<BodyReqSendEmailType>(_BodyReqSendEmail_QNAME, BodyReqSendEmailType.class, null, value);
    }
